    ...
    public function send(){
        ...
        foreach ($this->email_recipients as $recipient){
            ...
            if (static::$app->config('mail') == 'smtp'){
                ...
                $mail->isSMTP(true);
                $mail->Host =       static::$app->site->email_host;
                $mail->Port =       static::$app->site->email_port;
                $mail->SMTPAuth =   true;
                $mail->SMTPSecure = static::$app->site->email_secure;
                $mail->Username =   static::$app->site->email_username;
                $mail->Password =   static::$app->site->email_pass;
